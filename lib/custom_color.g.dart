...
const customcolor1 = Color(0xFF7569F3);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF7569F3),
  customcolor1: Color(0xFF5648D2),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFE4DFFF),
  onCustomcolor1Container: Color(0xFF140067),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF7569F3),
  customcolor1: Color(0xFFC5C0FF),
  onCustomcolor1: Color(0xFF2500A1),
  customcolor1Container: Color(0xFF3D2BBA),
